...
<!-- Exemplo de uso:
![Tela principal com gráfico candlestick](docs/images/screenshot-home.png)
![Painel de indicadores técnicos](docs/images/screenshot-indicators.png)
![Sinal do modelo DQN](docs/images/screenshot-dqn-signal.png)
-->
